...
$(function () {
    ...
    akAccess = function () {
        ...
        function _setFontSize(size) {
            ...
            for (key in sizes) if (size === key) chosenSize = key;
        ...
        function _setContrast(contrast) {
            ...
            if (contrast === "normal") $("body").removeClass(contrasts.join(" ")); else $("body").addClass(contrast);
...
$.fn.stacktable = function (options) {
    var $tables = this, defaults = {id: "stacktable", hideOriginal: false}, settings = $.extend({}, defaults, options);
    return $tables.each(function () {
        ...
        $table.find("tr").each(function (index, value) {
            markup += "<tr>";
            if (index === 0) markup += '<tr><th class="st-head-row st-head-row-main" colspan="2">' + $(this).find("th,td").eq(0).html() + "</th></tr>"; else $(this).find("td").each(function (index, value) {
                if (index === 0) markup += '<tr><th class="st-head-row" colspan="2">' + $(this).html() + "</th></tr>"; else if ($(this).html() !== "") {
                    markup += "<tr>";
                    if ($topRow.find("td,th").eq(index).html()) markup += '<td class="st-key">' + $topRow.find("td,th").eq(index).html() + "</td>"; else markup += '<td class="st-key"></td>';
...
(function ($) {
    var has_VML, has_canvas, create_canvas_for, add_shape_to, clear_canvas, shape_from_area, canvas_style,
        hex_to_decimal, css3color, is_image_loaded, options_from_area;
    var margin_left;
    ...
    o.prototype = {
        init: function () {
            ...
            if (t.populateLitebox(o), t.options.overlayClose && $litebox.on("click", function (o) {
                ...
                var t = this, i = this.$element.attr("rel"), l = e('[rel="' + this.$element.attr("rel") + '"]'), a = [];
            ...
            $litebox = e("<div>", {"class": "litebox-overlay"}), $close = e("<div>", {
                "class": "litebox-close " + this.options.closeTip,
                "data-tooltip": this.options.closeTipText
            }), $text = e("<div>", {"class": "litebox-text"}), $error = e('<div class="litebox-error"><span>' + this.options.errorMessage + "</span></div>"), $prevNav = e("<div>", {
            ...
            }), $container = e("<div>", {"class": "litebox-container"}), $loader = e("<div>", {"class": "litebox-loader"}), e("body").prepend($litebox.css({"background-color": this.options.background})), $litebox.append($close, $text, $prevNav, $nextNav, $container), $litebox.fadeIn(this.options.revealSpeed)
        }, populateLitebox: function (t) {
            var o = this, i = t.attr("href"), n = e(".litebox-content");
            ...
            } else if ("#" == i.substring(0, 1)) e(i).length ? ($html = e("<div>", {"class": "litebox-content litebox-inline-html"}), $html.append(e(i).clone()), o.transitionContent("inline", n, $html)) : o.liteboxError(), $loader.remove(); else {
                var s = e("<iframe>", {
                    src: i,
                    frameborder: "0",
                    vspace: "0",
            ...
            $litebox.css({height: i()}), $container.css({"line-height": $container.height() + "px"}), "undefined" != typeof $html && e(".litebox-inline-html").outerHeight() < $container.height() && e(".litebox-inline-html").css({
...
(function (e) {
    ...
    e.widget("ui.resizable", e.ui.mouse, {
        ...
        _mouseDrag: function (t) {
            var i, s = this.helper, a = {}, n = this.originalMousePosition, r = this.axis, o = this.position.top,
                h = this.position.left, l = this.size.width, u = this.size.height, c = t.pageX - n.left || 0,
                d = t.pageY - n.top || 0, p = this._change[r];
        ...
        _respectSize: function (e) {
            var t = this._vBoundaries, s = this.axis, a = i(e.width) && t.maxWidth && t.maxWidth < e.width,
                ...
                u = /sw|nw|w/.test(s), c = /nw|ne|n/.test(s);
        ...
        stop: function (t) {
            var i = e(this).data("ui-resizable"), s = i.options, a = i._proportionallyResizeElements,
                n = a.length && /textarea/i.test(a[0].nodeName),
                r = n && e.ui.hasScroll(a[0], "left") ? 0 : i.sizeDiff.height, o = n ? 0 : i.sizeDiff.width,
        ...
        start: function () {
            var i, s, a, n, r, o, h, l = e(this).data("ui-resizable"), u = l.options, c = l.element, d = u.containment,
            ...
            var i, s, a, n, r = e(this).data("ui-resizable"), o = r.options, h = r.containerOffset, l = r.position,
                u = r._aspectRatio || t.shiftKey, c = {top: 0, left: 0}, d = r.containerElement;
            ...
            var t = e(this).data("ui-resizable"), i = t.options, s = t.containerOffset, a = t.containerPosition,
                n = t.containerElement, r = e(t.helper), o = r.offset(), h = r.outerWidth() - t.sizeDiff.width,
        ...
        start: function () {
            ...
            var s = e(this).data("ui-resizable"), a = s.options, n = s.originalSize, r = s.originalPosition, o = {
                ...
                e(t).each(function () {
                    var t = e(this), a = e(this).data("ui-resizable-alsoresize"), n = {},
        ...
        resize: function () {
            var t = e(this).data("ui-resizable"), i = t.options, s = t.size, a = t.originalSize, n = t.originalPosition,
                r = t.axis, o = "number" == typeof i.grid ? [i.grid, i.grid] : i.grid, h = o[0] || 1, l = o[1] || 1,
                u = Math.round((s.width - a.width) / h) * h, c = Math.round((s.height - a.height) / l) * l,
                d = a.width + u, p = a.height + c, f = i.maxWidth && d > i.maxWidth, m = i.maxHeight && p > i.maxHeight,
    ...
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        _intersectsWith: function (e) {
            var t = this.positionAbs.left, i = t + this.helperProportions.width, s = this.positionAbs.top,
                ...
                d = "y" === this.options.axis || t + u > n && r > t + u, p = c && d;
        ...
        _generatePosition: function (t) {
            var i, s, a = this.options, n = t.pageX, r = t.pageY,
...
(function (e, t) {
    ...
    e.extend(i.prototype, {
        ...
        parseDate: function (i, a, s) {
            ...
            var n, r, o, h, l = 0, u = (s ? s.shortYearCutoff : null) || this._defaults.shortYearCutoff,
                ...
                f = (s ? s.monthNames : null) || this._defaults.monthNames, g = -1, v = -1, y = -1, b = -1, _ = !1,
                k = function (e) {
                    var t = i.length > n + 1 && i.charAt(n + 1) === e;
                    return t && n++, t
                }, x = function (e) {
                    var t = k(e), i = "@" === e ? 14 : "!" === e ? 20 : "y" === e && t ? 4 : "o" === e ? 3 : 2,
                        s = RegExp("^\\d{1," + i + "}"), n = a.substring(l).match(s);
        ...
        _generateHTML: function (e) {
            var t, i, a, s, n, r, o, h, l, u, d, c, p, m, f, g, v, y, b, _, k, x, D, w, T, M, S, N, C, A, P, I, F, j, H,
                E, z, L, O, R = new Date,
                W = this._daylightSavingAdjust(new Date(R.getFullYear(), R.getMonth(), R.getDate())),
                Y = this._get(e, "isRTL"), J = this._get(e, "showButtonPanel"), $ = this._get(e, "hideIfNoPrevNext"),
                Q = this._get(e, "navigationAsDateFormat"), B = this._getNumberOfMonths(e),
                K = this._get(e, "showCurrentAtPos"), V = this._get(e, "stepMonths"), U = 1 !== B[0] || 1 !== B[1],
                G = this._daylightSavingAdjust(e.currentDay ? new Date(e.currentYear, e.currentMonth, e.currentDay) : new Date(9999, 9, 9)),
                q = this._getMinMaxDate(e, "min"), X = this._getMinMaxDate(e, "max"), Z = e.drawMonth - K,
                et = e.drawYear;
...
(function (e) {
    ...
    e.effects.effect.blind = function (a, s) {
        var n, r, o, l = e(this), h = ["position", "top", "bottom", "left", "right", "height", "width"],
            u = e.effects.setMode(l, a.mode || "hide"), d = a.direction || "up", c = t.test(d),
            p = c ? "height" : "width", f = c ? "top" : "left", m = i.test(d), g = {}, v = "show" === u;
...
(function (e) {
    e.effects.effect.clip = function (t, i) {
        var a, s, n, r = e(this), o = ["position", "top", "bottom", "left", "right", "height", "width"],
            l = e.effects.setMode(r, t.mode || "hide"), h = "show" === l, u = t.direction || "vertical",
...
;(function (d) {
    d.fn.marquee = function (w) {
        return this.each(function () {
            var a = d.extend({}, d.fn.marquee.defaults, w), b = d(this), c, k, p, q, h, l = 3,
            ...
            (e = !0), g[w]()); else {
                ...
                if (a.allowCss3Support) {
                    var f = document.body ||
                        document.createElement("div"), n = "marqueeAnimation-" + Math.floor(1E7 * Math.random()),
...
(function (e) {
    e.fn.vTicker = function (t) {
        ...
        return this.each(function () {
            var n = e(this);
            var i = 0;
            n.css({overflow: "hidden", position: "relative"}).children("ul").css({position: "absolute"});
            if (t.height == 0) {
...
!function (t, s, a) {
    ...
    e.prototype.init = function () {
        ...
        var s = this, a = this.$element.children("ul:first"), e = [], o = 0;
...
(function (d) {
    ...
    e.prototype = {
        defaults: {type: "overlap", levelSpacing: 40, backClass: "mp-back"}, _init: function () {
            this.open = false;
            this.level = 0;
...
(function ($) {
    ...
    $.expr[":"].appeared = function (element) {
        ...
        var top = offset.top;
        if (top + $element.height() >= window_top && top - ($element.data("appear-top-offset") || 0) <= window_top + $window.height() && left + $element.width() >= window_left && left - ($element.data("appear-left-offset") || 0) <= window_left + $window.width()) return true; else return false
    };
    $.fn.extend({
    ...
    if (typeof module !== "undefined") return require("jquery"); else return jQuery
}());
